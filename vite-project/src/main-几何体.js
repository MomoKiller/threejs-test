...
// 父元素材质
const parentMetrial = new THREE.MeshBasicMaterial({ color: 0xff0000 })
// 设置父元素为线框模式
parentMetrial.wireframe = true


// 父元素
let parentCube = new THREE.Mesh(geometry, parentMetrial)
...
gui.add(parentMetrial, "wireframe").name("父元素的线框模式")
